/**
 * app/donate/DonateContent.tsx
 *
 * Client content component for config-driven donation checkout flow.
 * Wrapped in Suspense boundary inside the page wrapper to support SSG/Prerendering.
 */
"use client";
